...
<template>
    <div
        class="bg-card flex w-56 flex-none flex-col overflow-hidden rounded-2xl border"
    >
        <Link
            :href="businessShow(business.slug)"
            class="bg-muted relative block h-20"
        >
            <img
                v-if="business.cover"
                :src="business.cover"
        ...
        <div class="-mt-7 flex flex-1 flex-col px-3.5 pb-3.5">
            ...
            <Link
                :href="businessShow(business.slug)"
                class="mt-1 flex items-center gap-1 font-bold hover:underline"
            >
            ...
            <p class="mt-1.5 flex items-center gap-1.5 text-xs">
                ...
                <span
                    v-else
                    class="bg-wait-soft text-wait rounded-full px-2 py-0.5 font-bold"
                    >Nuevo</span
                >
            </p>
            <div class="mt-3">
