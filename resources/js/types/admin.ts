...
export const planCapabilities: {
...
}[] = [
    {
        key: 'can_promote',
        label: 'Promocionado',
        hint: 'Sale como publicidad en el Inicio de quienes aún no lo siguen.',
    },
    {
        key: 'can_checkout',
        label: 'Vender en la app',
        hint: 'Carrito y pedidos desde su perfil.',
    },
    {
        key: 'can_reserve_stock',
        label: 'Control de inventario',
        hint: 'Aparta existencias al recibir un pedido.',
    },
    {
        key: 'can_use_team',
        label: 'Equipo',
        hint: 'Invitar a otras personas a administrar el negocio.',
    },
    {
        key: 'can_invoice',
        label: 'Factura electrónica',
        hint: 'Emitir FEL desde Silvestre.',
    },
];
